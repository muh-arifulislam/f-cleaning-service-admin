          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                ...
                >
                  <span className="mr-2">
                    <BiCommentCheck className="text-lg inline" />
                  </span>
              ...
              <li className="items-center">
                ...
                >
                  <span className="mr-2">
                    <FaImages className="text-lg inline" />
                  </span>
              ...
              <>
                ...
                <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                  <li className="items-center">
                    <Link
                      onClick={() => setCollapseShow("hidden")}
                      className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold flex items-center justify-start"
                      to="user"
                    >
                      <span className="mr-2">
                        <MdAdminPanelSettings className="text-lg inline" />
                      </span>
